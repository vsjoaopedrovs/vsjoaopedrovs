...
USER_NAME = os.environ['USER_NAME']  # 'vsjoaopedrovs'
...
if __name__ == '__main__':
    """
    João Pedro Vieira Silveira (vsjoaopedrovs), 2024-2025
    """
    ...
    # ── Calcula idade (nascido em 19/08/2009) ─────────────────────────────────
    age_data, age_time = perf_counter(daily_readme, datetime.datetime(2009, 8, 19))
    formatter('age calculation', age_time)

    # ── Linhas de código (com cache de 7 linhas de comentário) ───────────────
